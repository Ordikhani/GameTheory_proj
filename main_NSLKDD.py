"""
The final project of game theory course.
The subject of the project: detection of attacks in the computer network and ...
finding the best defense method by Bayesian game of game theory.
Database used: KDD-CUP 1999
Database download site: https://www.unb.ca/cic/datasets/nsl.html
  and  or https://www.unb.ca/cic/datasets/nsl.html
My GitHub address: https://github.com/Ordikhani
Project path in my GitHub: https://github.com/Ordikhani/GameTheory_proj
Python Version : Python 3.7
Project manager: student Fateme Ordikhani
"""
...
dataset_root = 'Data/NSL-KDD-Dataset'
...
with open('Data/NSL-KDD-Dataset/training_attack_types.txt', 'r') as f:
